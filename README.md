...
记录从 2025 年开始的 Python 与 AI 学习实践，仓库涵盖编程基础、数学、Web 开发、
网络爬虫、机器学习、深度学习与 LLM 等方向的读书笔记、示例代码和项目练习。
...
### [面对问题，一看到答案时就会，自己动手时又不会](./thinking.md)

## 问题记录

[ ] Github 渲染 md 文件时默认不会启用 LaTex 语法解析引擎，导致有些笔记中的数学公
式展示成了原文，可以下载到本地使用 Markdown 软件阅读
